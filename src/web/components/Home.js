  ...
  <div>
    <Row>
      <Jumbotron className="bg-primary text-white">
        <h1>
          Achat et ventes de légumes sans intermédiaires.
        </h1>
        <p className="lead">
          Si vous en avez marre de travailler pour payer des intermédiaires inutiles ou
          si vous voulez consommer local et retisser du lien entre vous et votre Terre...
        </p>
        <p>
